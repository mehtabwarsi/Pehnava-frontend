import { ChevronLeft, MapPin, User, Phone, Home, Briefcase, Info } from "lucide-react";
                ...
                <div className="bg-white rounded-3xl p-6 sm:p-10 shadow-soft border border-pehnava-border/40">
                    <form className="space-y-6">
                        ...
                        <div className="space-y-4 pt-4 border-t border-pehnava-border/40">
                            ...
                            <div className="flex gap-4">
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl font-bold transition-all ${addressType === "Home"
                                ...
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl font-bold transition-all ${addressType === "Work"
                                        ? "bg-pehnava-charcoal text-white shadow-md scale-[1.02]"
                                        : "bg-pehnava-offWhite text-pehnava-slate border border-pehnava-border"}`}
                                >
                        ...
                        <div className="pt-6">
                            <button
                                type="submit"
                                className="w-full py-4 rounded-2xl bg-pehnava-primary text-white font-bold text-lg hover:bg-pehnava-charcoal transition-all shadow-lg active:scale-[0.98]"
                            >
                                Save Address
                            </button>
                        </div>
